  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
        ...
        {/* LOGO */}
        <div onClick={() => scrollToSection("home")} className="cursor-pointer flex items-center gap-2">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button 
            ...
            "
          >
            {/* The Liquid Fill Layer (Expands from bottom) */}
            <span className="
            ...
            {/* The Text (Ensures it sits on TOP of the fill) */}
          ...
          {/* SIGN UP BUTTON */}
          <button className="px-6 py-2.5 rounded-full text-sm font-bold text-white bg-cyan-500 hover:bg-cyan-600 shadow-lg shadow-cyan-500/30 hover:scale-105 transition-all">
            Sign Up
          </button>
        </div>
      </div>
